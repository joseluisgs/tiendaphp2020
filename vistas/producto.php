                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            if (isset($_SESSION['id_usuario']) && $producto->getDisponible() == 1 && $producto->getStock() > 0) {
                                ...
                                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>"
                                    ...
                                    <input type="number" name="uds" value="1" min="1"
                                           max="<?php echo $producto->getStock(); ?>"> Uds
                                    <button type="submit" class="btn btn btn-default"><span
                                                class='glyphicon glyphicon-shopping-cart'></span> Añadir
                                    </button>
                                    <input type="hidden" id="id" name="id"
                                           value="<?php echo encode($producto->getId()); ?>">
                            ...
                            <div>
                                ...
                                <div class="col-md-offset-6 col-md-9">
                                    <p><a href="catalogo.php" class="btn btn-primary"><span
                        ...
                        <div class="col-md-6 form-group">
                            <div>
                                <br><br>
                                <img src='../img_productos/<?php echo $producto->getImagen(); ?>' class='rounded'
                                     class='img-thumbnail' width='380' height='auto' enctype="multipart/form-data">
                            </div>
                        </div>
                    </div>
