    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            if (isset($_SESSION['nombre'])) {
                ...
                echo "<li><a href='/tienda/vistas/usuarios_actualizar.php?id=". encode($_SESSION['id_usuario'])."&email=".encode($_SESSION['email'])."'><span class='glyphicon glyphicon-user'></span> ". $_SESSION['alias']. " </a></li>";
