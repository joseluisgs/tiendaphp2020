    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            if (isset($_SESSION['nombre'])) {
                echo "<li><a href='/tienda/vistas/carritoMostrar.php' class='cart-link' title='Ver Carrito'> <b>".$_SESSION['uds']."</b> <span class='glyphicon glyphicon-shopping-cart'></span></a></li>";
