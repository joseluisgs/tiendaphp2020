    ...
    <main role="main">
                            ...
                            <div class="table-responsive">
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-line text-right"><strong><?php echo $venta->getTotal(); ?>
                                                €</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <div class="row no-print nover">
            <div class='text-center'>
                <a href="javascript:window.print()" class='btn btn-info'><span class='glyphicon glyphicon-print'></span>
                    Imprimir </a>
                <a href="../index.php" class='btn btn-success'><span class='glyphicon glyphicon-ok'></span> Finalizar
                </a>
                <?php
